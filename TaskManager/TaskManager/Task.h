...
public:
  ...
  Task(const std::string &name_, int priority_, const std::string &description_,
       const ChronoDate &start_date_, const ChronoDate &end_date_,
  ...
  Task(const std::string &name_, int priority_, const ChronoDate &due_date_,
       const Category &cat_);
  Task(const std::string &name_, int priority_, const std::string &description_,
       const ChronoDate &start_date_, const ChronoDate &due_date_);
  ...
  void getDescription(std::string &description_) const {
