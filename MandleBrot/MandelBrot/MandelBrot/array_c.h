...
public:
	...
	array_c(const array_c_y_major& _in) = delete;
	array_c& operator=(const array_c_y_major& _in) = delete;
	array_c(array_c_y_major&& _in) = default;
	array_c& operator=(array_c_y_major&& _in) = default;
	~array_c() {
		deallocate();
	}
