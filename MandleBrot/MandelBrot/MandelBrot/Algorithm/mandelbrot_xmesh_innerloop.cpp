...
mandelbrot_xmesh_innerloop::mandelbrot_xmesh_innerloop(
	...
	mandelbrot_xmesh{ _alloc_mode,_alloc_major, _bnds,
	_n_xs, _n_ys, thread_cfg_, _file_name,num_iterations_, gamma_ }
{}


void mandelbrot_xmesh_innerloop::calculate(const double& _scale)
