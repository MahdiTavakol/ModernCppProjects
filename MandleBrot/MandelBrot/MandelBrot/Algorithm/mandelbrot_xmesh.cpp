...
mandelbrot_xmesh::mandelbrot_xmesh(/* allocation config */ const allocation_mode& _alloc_mode, const allocation_major& _alloc_major,
	...
	mandelbrot{ _alloc_mode,_alloc_major, _bnds, 
	            _n_xs, _n_ys, _file_name, num_iterations_, gamma_},
