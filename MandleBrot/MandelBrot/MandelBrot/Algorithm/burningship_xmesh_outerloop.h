...
namespace Mandelbrot_NS {
	class burningship_xmesh_outerloop final : public mandelbrot_xmesh
	{
	public:
		burningship_xmesh_outerloop(/* allocation config */ const allocation_mode& _alloc_mode, const allocation_major& _alloc_major,
