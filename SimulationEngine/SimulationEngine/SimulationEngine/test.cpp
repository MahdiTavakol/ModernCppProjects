...
TEST_CASE("Testing updating the ghost atoms in the particles class") {
    ...
    std::vector<double> expectedXs1 = {
        -220.40, -180.10,   80.55,   // particle 0  owned by Q00 (-- interior)
        -140.75, -260.33, -120.18,   // particle 1  owned by Q00 (-- interior)
         -35.10, -140.48,   12.66,   // particle 11 owned by Q00 (-- interior)
        -180.66,  -30.77,   14.95,   // particle 15 owned by Q00 (-- interior)
         -12.60,  -18.90,  130.10,   // particle 19 owned by Q00 (-- interior)
    ...
    std::vector<double> expectedXs2 = {
         180.62, -210.44,   60.91,   // particle 2  owned by Q10 (+- interior)
         260.11, -140.88, -200.30,   // particle 3  owned by Q10 (+- interior)
          25.60, -160.15,  -55.27,   // particle 8  owned by Q10 (+- interior)
          18.40,  -22.10,   95.50,   // particle 16 owned by Q10 (+- interior)
         190.27,  -40.22, -236.70,   // particle 18 owned by Q10 (+- interior)
    ...
    std::vector<double> expectedXs3 = {
        -200.90,  190.36,  -40.58,   // particle 4  owned by Q01 (-+ interior)
        -270.22,  120.74,  210.46,   // particle 5  owned by Q01 (-+ interior)
        -120.33,   20.18, -199.05,   // particle 9  owned by Q01 (-+ interior)
         -22.80,   18.10, -140.25,   // particle 13 owned by Q01 (-+ interior)
         -28.20,  180.66,   66.03,   // particle 17 owned by Q01 (-+ interior)
    ...
    std::vector<double> expectedXs4 = {
         210.83,  220.41, -150.88,   // particle 6  owned by Q11 (++ interior)
         140.62,  160.33,  198.21,   // particle 7  owned by Q11 (++ interior)
          30.25,   22.40,   10.66,   // particle 10 owned by Q11 (++ interior)
         160.81,   35.42,  289.73,   // particle 12 owned by Q11 (++ interior) 
          40.11,  170.25,  204.67,   // particle 14 owned by Q11 (++ interior)
