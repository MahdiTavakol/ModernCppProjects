...
TEST_CASE("Testing the spring field ")
{
	std::cout << "Testing the spring field" << std::endl;
	...
	// The spring object
	std::unique_ptr<SpringField> spring_ptr =
		std::make_unique<SpringField>(connectionInfo);
	...
	inputs.push_back(std::move(spring_ptr));
