...
translate::translate(std::unique_ptr<hittable> object_, const vec3& offset_)
    :hittable{object_->type}, object{std::move(object_)}, offset(offset_)
{
...
rotate_y::rotate_y(std::unique_ptr<hittable> object_, double angle_) : 
    hittable{ object_->type }, object{ std::move(object_) }
{
    double radians = degrees_to_radians(angle_);
