...
{
public:
	LayerBatchEfficient(Logger& logger_, const int& batchsize_, const int& InputFileDim_,
		const int& outputDim_, const ActivationType& activType_);
	...
	virtual void update(const std::unique_ptr<Optimizer>& OptFuncPtr_);
