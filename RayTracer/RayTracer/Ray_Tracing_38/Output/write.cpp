...
writer::writer(std::string _file_name, color_array* _colors, int _image_width, int _image_height) : 
...
writer::writer(std::string _file_name) : writer(_file_name, nullptr, 0, 0) {}
...
void writer::reset(color_array* _colors, const int _image_width, const int _image_height)
{
	this->colors = _colors;
...
void writer::open_new_file(std::string _file_name)
{
